...
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_seq_write_avg_speed_bar.png)

再看 **随机写**：随机写的写放大较低，所以性能较低
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_rand_write_avg_speed_bar.png)
...
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_seq_read_avg_speed_bar.png)

再看 **随机读**：随机读缓存命中率很低，所以性能都比顺序读要差很多

![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_rand_read_avg_speed_bar.png)
...
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_seq_write_time_speed.png)

再看 **随机写**

![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_rand_write_time_speed.png)
...
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_seq_read_time_speed.png)
...
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_rand_read_time_speed.png)
...
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_seq_read_avg_speed_percent_bar.png)
...
![](/source/性能测试/Todis-he-TairDB-读写-strings-性能对比/strings_rand_read_avg_speed_percent_bar.png)
